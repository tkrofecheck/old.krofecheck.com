...
define(['jquery', 'underscore', 'handlebars', 'masonry', 'tools'],
    function($, _, Handlebars, Masonry) {
        ...
        $(function() {
            myApp.Tools.customModal.injectScript(); // add handlebars template for custom modal to HEAD
        });

        //do stuff
        require(['app/about', 'app/resume', 'app/portfolio'], function() {
